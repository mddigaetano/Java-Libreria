public class Libreria {
    public static void main(String [] args){
        ...
        Libro sao1 = new Libro("avventura", "Aincrad 1", 250, (float)19.50);
        Libro sao2 = new Libro("avventura", "Aincrad 2", 300, (float)19.50);
        Libro toradora1 = new Libro("sentimentale", "Toradora 1", 150, (float)14.90);
